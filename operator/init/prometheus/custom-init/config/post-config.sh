...
echo "====== try copying the jar into /opt/amq/lib ========"
cp /amq/prometheus-plugin/artemis-prometheus-metrics-plugin-1.1.0.CR1/artemis-prometheus-metrics-plugin/target/artemis-prometheus-metrics-plugin-1.1.0.jar /opt/amq/lib
